...
export default () => {
  ...
  return <div style={{textAlign: "left"}}>
          ...
          <div>Inception to date of Gas Fee <Tooltip text={term.gas_fee} /> : <strong className="green">{formatWithCommas(gasFee)} Ⓝ 
              {gasFeeWeekAgo && <Diff current={gasFee} prev={gasFeeWeekAgo} />}</strong></div>
