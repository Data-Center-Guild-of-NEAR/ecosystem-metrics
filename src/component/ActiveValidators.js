  ...
  return (
    <div style={{ textAlign: 'left' }}>
      ...
      <div>
        ...
        <strong className="green">{validators}</strong>
      </div>
      <div>
        Current Proposals <Tooltip text={term.current_proposals} /> :{' '}
        <strong className="green">{proposals}</strong>
      </div>
      <div>
        Next Validators <Tooltip text={term.next_validators} /> :{' '}
        <strong className="green">{nextValidators}</strong>
      </div>
    </div>
  );
};
